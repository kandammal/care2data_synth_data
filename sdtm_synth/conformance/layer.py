"""
SDTM Synthetic Data Generator - Conformance Layer

This module provides the ConformanceLayer class that validates and
optionally corrects SDTM datasets.
"""
    ...
    def _repair_dm_rfendtc(
        ...
        for idx, row in dm_fixed.iterrows():
            ...
            if usubjid in disp_dates:
                ...
                # Also update RFPENDTC if it exists
